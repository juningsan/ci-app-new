...
const poems = Object.fromEntries(
    Object.entries(poemContents).map(([title, content]) => [
        title,
        {
            content,
            time: "",
...
poems["引越集"].time = "2022-2025";
poems["引越集"].description = `生如夏花之绚烂。一段时间里，每当清晨经过孩子的幼儿园，奔向几分钟后搔头作态的工位，心里便会发生时间错位的恍惚。事情往往坎坷，预期仅仅是预期。看了一些朋友推荐的正念书籍，在币圈看了一眼。
彤彤时常为太阳变成红巨星吞没地球，冰川融化淹没城市担心。当说出几十亿年后或几百年后发生作为宽慰时，就会发现一个问题，关于流逝的时间里人的一生，和作为灵魂的永恒，又该如何解释。
牛市已经到来。`;
poems["洗练集"].time = "2021-2022";
poems["洗练集"].description = `当三十之岁，初之豪言，空覆尘土。孩提日进半步，责任日重十石。左右偶有提携，世事未觑分明，只觉流徙之间，才有不逮，力有不满，气有不足。犹觉晴天可爱，雨夜疏明，雪窗含笑，花朝堪亲。儿童天真之语，郁垒之涂，顽劣之迹，概卅年前一个我也，何以不喜？至于战火之仍，百市之弊，国步之艰，能唱衰之，便能令起之，时之先后有序也，力之大小有殊也。是为序。`;
poems["潜用集"].time = "2020";
poems["潜用集"].description = `庚子一岁，半载精奋，半载顽痴，而立未立，委运因时。唯乳儿乘肩，促膝引唤，或史册偶抚，影戏抛年，忽不觉窗外节序如水，阶前春草，再看萧萧。计数之世，力不逮焉，但守一壤安田，半牖荫蔽，稍得寄宿，抟养儿曹，教予贤声。他日之日，他山之山，未能测定，便如此足。`;
poems["存续集"].time = "戊戌跨年";
poems["存续集"].description = `出离半岁有余，在刀锋棍棒场，烟柳明胜处，跌堕数度，折腾几番，终不免败兴而终。回首来路，也只有衰诗丑词三纸，聊以供酒，冀为存续。`;
poems["废名集"].time = "2017春夏之间";
poems["废名集"].description = `有造境，有写境。有有我之境，有无我之境。一切景语皆情语，一切情语从心生。天地有道，万物有灵；天长水阔，且歌且行。`;
poems["无雪集"].time = "2016-2017";
poems["无雪集"].description = `昔年喜雪，其纷然飒沓，纯净须弥，宁寂孤清，皆入我怀。《雪国》之书既弃，断桥残雪亦虚，心中无雪久矣。冬来不见雪，落而屡错之，亦未为意。所以心境不在也。画符摸象，学而罔精，跳跃篱间，止为生计著。生计可谋，然心境其下，恐无力着起矣。下其无可下，或有隐力而抬升乎？信之，下之。悠然如坠鸟也，萧然如落木也。以为序。`;
poems["哀秋集"].time = "2016";
poems["哀秋集"].description = `时乖运舛，岁月蹉跎，谁与共说，伤如之何！`;
poems["春日集"].time = "2016春";
poems["春日集"].description = `腊月寒天，一年风絮，载雪还家。及月底，回岘子老院，为祖母二十周年祭。蓦然掐指，去祖父离世，亦足六载矣。岁添人寿，日月跑马，于彼迄今，竟一事无成，一技未得。止于蕞尔之所，苟图衣食，怀疚先祖，愧对二公。噫!

    抵年关，炮竹馐馔，一无兴趣。家中来客亦萧疏无几，以老人不在故也。终日投壶游戏，十五未及，匆匆返路。

    飞机中转武汉，之黄鹤楼。历历晴川，萋萋芳草，上古旨趣，近代烽燧，浮在脑际。其次有铁路，迨列车经过，郁怀逐远，青烟一行，摇曳行天。

    抵杭，复于蔽薮，惶然度日。清明，之南京。时雨，游中山陵。先生气度，昂然钟山上下；明皇帝气，隐乎松石内外。秦淮河畔，吃茶看戏，微雨朦胧，烟光流泛，仿佛六朝繁华；总统府内，登高望远，砖石赫赫，党国气派，如在眼前。

    又三四月间，家父举全家财力，置业于杭，址于紫金港学区次。年内订亲，期年成婚。以近卅之身，父母之供，甘食锦衣，章台走马，不无愧怍。进取之志，潜心之学，时断时续，力不能饱。

    五月已至，半岁将弥。学一门技艺，读三五好书，会一二故友，以为愿。`;
poems["归来集"].time = "2015";
poems["归来集"].description = `若道14年为历劫之一年，15年洵为再造之一年也。春，南渡珠海。板障山前，伶仃洋边，以父母之供，纵闲散之身。海天胜景，南国风光，眼底一转。而念及将来，无用之身，竟不知所以。遂习计算机，以便求职。孤注已掷，前路未知，自大学以来，凡用心之处，无不游戏人生，此番抉择，如笃志践行，或能扳回运命。虽然，心终不能平静。谋职无果，心烦意乱。某日，与同窗交谈，荐余杭州之职。旧日记忆，翻然动心，湖山俦侣，一时入目。四月抵杭入职，匆匆一岁，平淡如水。仍于闲时学习，刀塔，诗词不辍。劝君更进一杯酒，西出阳关无故人。杭州有故友，孤山有气节，虽无酒可进，然酲醉喜乐，生计微薄，然果腹者足。前路如何，尽人事，听天命而已。是为序。`;
poems["槁木集"].time = "2010-2011"; 
poems["槁木集"].description = `自戊子乡试毕，饮醉一夏，昼夜交欢，惶惶不复初心。及至钱塘，携祖父乡人游于西湖岳庙，稍稍玩乐。忆年前临湖听戏之梦，与眼前烟波相映，亦真亦假，不禁慨然。至庠序，堂庑遂深。初，励精策力，以图自强。然前欢抛掷，心已劳困。周遭宵小，更无所亲。春节还乡，祖父溘逝，其病业半载有余，盖因乡试事大，隐而不宣。廿载恩情，竟无以为报，中心坍圮，万念俱灰。后虽竭力振作，入于高阁，终放浪形骸，投壶弄剑，聊以度日，诗词亦疏矣。殆天力之所为，人世之巧作，孰能料定？十年磨剑，一朝失势，泯然众人。后迁至本部，梧桐繁茂，桂花盈香，郁结稍通，期复抬头。然公式理数，已无趣可兴，靡靡终日，一无所树。此间诗词杂沓甚多，然已无亮丽者。噫！商女不知亡国恨，隔江犹唱后庭花。确乎其所谓。`;
poems["荒山集"].time = "2009年以前";
poems["荒山集"].description = "";
poems["机变集"].time = "2013-2014";
poems["机变集"].description = `夫世事如荣枯之木，人情似走马之灯。念前朝之旧事，非悬崖而不思革变，非刀俎而不知从流。而亡羊补牢，雨后撑伞，其时已晚矣。临歧路则当立断，遇阻遏则思机变，此事之所以得成。心如不倒之翁，意随骑墙之草，此人之所以败亡。壬辰春夏，西借东抄，草成论文，上媚下谄，聊得卒业。既出校门，较初来之我，除一纸文凭，一腔愤懑，一脸茫然，竟了无他长。信步西湖，水明灭而斜顾，山重叠以相讥。记昔年之骋力，圣贤之训诫，父母之嘱托，乡人之寄望，与这湖山天地，一并辜负，不禁怃然。辗转得荐于蕞尔之所，以斗米之供，稍寄落魄之身。国庆之际，与姗会于山城，柳明花笑，山高气壮，纵赏幽游，浑无失意之痛。同庆予本命生辰，待别南浦，双双泫然。期日年关，复邀姗来杭，同出共入十日，烧饭洗衣，贤良温恭。然睹予头疾时复，灵台无光，曾相拥而泣。及分携，藏信字一页于书中。后得见，乃嘱予少烟酒，多欢笑，数日重逢也。岁寒渐深，一日雪夜，忽闻寓所橱内有禽鸟振翅之声，启之空无一物。心内恐极，待稍镇定，因思及贾谊之《鵩鸟赋》，其鸟元为不详之物也。然贾谊道：“天不与虑兮，道不可与谋；迟速有命兮，焉识其时！”，复道：“其生兮若浮，其死兮若休；澹乎若深渊之静，泛乎若不系之舟。”贾谊者，本开通旷达之士也，玩味其赋，思鸟鸣事，遂不以为意。回乡前夜，戾气复发，黑金旋死，浸淫蹈舞，疾志一文，名之《路西法大人的生活日记》，言撒旦饮血之事，落笔大笑，中心欢乐。殊不知，灾厄时已伏于一线也。春节相聚，自然欢喜。不述。癸巳 春三月，之上海赴慕尼黑光博会。是夜，宿友人处，游田汉旧宅，合影为纪。然予向来寡言，当夜则言谈不止，漫无边际。友愕然，以为病变，然予不以为然。一夜无眠，次日返回，先与车夫深谈，谈及基督教，世事变迁，赞予头脑灵光，临别，互留电话。后于列车遇三劳工，又以耶稣之事，博爱之情，意切情真，悬河不止。终了，三人竟次第啜泣。而予仍不予为意。至工所，困意甚重，遂拟休假半天。其间，有司女子恶语相向，终至予积郁迸发。扯烂假条，摔门而出。其时，耳边忽传人语，盖天地万物之大事，而予思维极速，与之问答，自觉妙不可言。翌日，与友赏花西湖，恍惚一日。再后，则近疯癫也。待予醒时，身在兰州。剩余之事，无益赘述。姗初忧虑，后踯躅，甚欲与我决断。待八月重见，相拥同泣，转而大笑。后半载，与姗卜居山城，名为太学备试，实为静养矣。予闻《西游记》序言有云：“文不幻不文,幻不极不幻。是知天下极幻之事,乃极真之事;极幻之理,乃极真之理。故言真不如言幻，言佛不如言魔。魔非他，即我也，我化为佛，未佛皆魔。”时隔一年，细忖个中滋味，洵为不识机变之所致也！噫嘻！亦不过置之一笑，为诸君喷饭供酒耳！`;
poems["拭镜集"].time = "2012";
poems["拭镜集"].description = `辛卯一年，流言末世将至。碌者无暇为念，达者权当一笑，唯蹉跎如我，驽钝如我，闲散如我者，竟翘首以盼。如飞蛾之扑火，如孤雁之得群，以为精神之力量，以为信仰之寄托。每讨玄说于网络，抵于深夜。及至昼间，不问学业，游乐终日，佐以诗词而已。静安所谓造境与写境，我止于前者也。至于岁末，浩劫之期，果无一芥之事。腊月寒天，愀然奔波自习室之间。夤夜归还，梧桐肃杀，银灯惨淡，茫茫天地，无与为亲。然则某日，偶于网络重识县学同窗，相谈甚欢。后隔日以清歌相荐，暖语相慰，竟不觉岁寒之凛冽。托锦书于鱼雁，而水长天远；寄相思于明月，而晴阴缺圆。何似而今之器械之利，虽千里之遥，而近如眼前。然器械虽利，又何似同还一乡，同在一檐，交杯共饮，醉卧怀间？是为两岁以降之欢喜，是为百年永续之良缘。`;
